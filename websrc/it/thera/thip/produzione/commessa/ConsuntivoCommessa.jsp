...
<!--<span class="mdvbutton" id="newMDV" name="newMDV"></span>--></td>
							<td>
								<button id="thAggiornaBUT" name="thAggiornaBUT" onclick="aggiornaConsuntivoView()" style="width:26px;height:26px;align:top" title="<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.ConsuntivoCommessa", "Aggiorna")%>" type="button"><img border="0" height="16px" src="thermweb/image/gui/cnr/Run.gif" width="16px">
								<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.ConsuntivoCommessa", "AggiornaID")%></button>
							</td>
						</tr>
					</table>
				</td>
