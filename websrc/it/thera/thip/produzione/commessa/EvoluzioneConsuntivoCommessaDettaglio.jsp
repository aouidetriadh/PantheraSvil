...
<%
	...
	EvoluzioneConsuntivoCommessaDetPQGrid paramQueryGrid = new EvoluzioneConsuntivoCommessaDetPQGrid(se); 
	paramQueryGrid.writeImport(writer);
%>	
			<div class="group-container" style="height:100%;">
					<% 
					if(paramQueryGrid.getEvoluzioneConsuntivoCommessa() != null) {
						List errors = paramQueryGrid.check();
						if(errors.isEmpty()) {
							paramQueryGrid.write(writer);
						}
						else{
							paramQueryGrid.manageErrorMessages(writer, errors);
						}
					}
					%>
			</div>
