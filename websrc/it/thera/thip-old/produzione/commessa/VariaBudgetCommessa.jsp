   ...
   <tr>
     <td height="100%"><div class="tabbed_pagine" id="tabbedPagine" style="position: relative; width: 100%; height: 100%;">
						<div class="tabbed_page" id="<%=mytabbed.getTabPageId("tab1")%>" style="width:100%;height:100%;overflow:auto;"><% mytabbed.startTab("tab1"); %>
							<table style="margin: 0 0 0 0 ;" width="95%">
								<tr>									
									<td valign="top">
										<table border="0" style="margin:0 0 0 0;" cellpadding= "0" cellspacinng="0">
											<tr>
												<td> 
													<table>
														<tr>
...
<!--<span class="mdvbutton" id="newMDV" name="newMDV"></span>--></td>
															<td>
																<button id="AggiornaBUT" name="AggiornaBUT" onclick="aggiornaVariaBudgetView()" style="width:90" title="<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "Aggiorna")%>" type="button"><%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "Aggiorna")%></button>
														</td>								
														</tr>
													</table>
												</td>
