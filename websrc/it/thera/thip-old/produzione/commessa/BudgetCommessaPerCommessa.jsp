...
<%
  ...
  WebForm BudgetCommessaForm =  
     new com.thera.thermfw.web.WebForm(request, response, "BudgetCommessaForm", "BudgetCommessa", null, "com.thera.thermfw.web.servlet.FormActionAdapter", false, false, false, false, true, true, null, 1, true, "it/thera/thip/produzione/commessa/BudgetCommessa.js"); 
  BudgetCommessaForm.setServletEnvironment(se); 
  BudgetCommessaForm.setJSTypeList(jsList); 
  BudgetCommessaForm.setHeader(null); 
  BudgetCommessaForm.setFooter(null); 
  BudgetCommessaForm.setWebFormModifierClass("it.thera.thip.produzione.commessa.web.BudgetCommessaPerCMMWebFromModifier"); 
...
%>
					...
					<!--input id="IdCommessa" name="IdCommessa" type="hidden"/-->
					<% 
...
%>
			...
			<tr>
				<td height="100%" valign="top">
					<table border="0" style="margin: 0 0 0 7px ;" width="90%">
						<tr style="display:none">
							<td nowrap><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "BudgetCommessa", "IdCommessa", null); 
...
<!--<span class="multisearchform" id="Commessa"></span>--></td>
						...
						<tr>
							<td nowrap width="120px"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "BudgetCommessa", "DataRiferimento", null); 
   label.setParent(BudgetCommessaForm); 
...
%>
							...
							<td nowrap rowspan="4" style="padding-right: 10px;" valign="top" width="230px">
...
%>
										...
										<!--<td>
											<button id="thApplicaScelte" name="thApplicaScelte" onclick="caricaDati()" style="width:26px;height:26px;align:top" title="<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "ApplicaScelte")%>" type="button"><img border="0" height="16px" src="thermweb/image/gui/cnr/Run.gif" width="16px">
											<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "ApplicaScelteID")%></button>
										</td>-->											
										<td><% 
  MDVButton newMDV =  
...
<!--<span class="mdvbutton" id="newMDV" name="newMDV"></span>--></td>
									<td>
								<button id="AggiornaBUT" name="AggiornaBUT" onclick="aggiornaBudgetView()" style="width:90" title="<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "Aggiorna")%>" type="button"><%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "Aggiorna")%></button>
								</td>											
										<td>
											<button id="thSalvaBudget" name="thSalvaBudget" onclick="salvaBudget()" style="width:26px;height:26px;align:top" title="<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "SalvaBudget")%>" type="button"><img border="0" height="16px" src="thermweb/image/gui/Save.gif" width="16px">
											<%= ResourceLoader.getString("it.thera.thip.produzione.commessa.resources.BudgetCommessa", "SalvaBudgetID")%></button>
										</td>	
									</tr>
								</table>
							</td>						
		         ...
		         <div id="DettaglioBudgetDiv" style="margin:0px 0px 0px 0px;"> 
		         <table cellpadding="0" cellspacing="0" style="height: calc(100% - 160px);width: calc(100% - 10px);margin-left:7px"  >	
		         <tr>
		         <td  nowrap="true">
		         <iframe height="100%" width="100%" id="BudgetCommessaDettaglio" name="BudgetCommessaDettaglio" src=""  style="border:0px;"></iframe>
		         </td>
		         </tr>
		         </table>
		         </div>
