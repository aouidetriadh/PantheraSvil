...
/**
 * EvoluzioneConsuntivoCommessaDetServlet
 ...
 */
public class EvoluzioneConsuntivoCommessaDetServlet extends BaseServlet {
   ...
   protected void caricaDati(ServletEnvironment se) throws Exception {
      ...
      EvoluzioneConsuntivoCommessa evoluzione = getEvoluzioneConsuntivoCommessa(se);
   ...
   public EvoluzioneConsuntivoCommessa getEvoluzioneConsuntivoCommessa(ServletEnvironment se) {
      EvoluzioneConsuntivoCommessa evoluzione = (EvoluzioneConsuntivoCommessa)Factory.createObject(EvoluzioneConsuntivoCommessa.class);
