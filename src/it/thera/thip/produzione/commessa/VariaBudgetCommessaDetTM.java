 ...
 */
public class VariaBudgetCommessaDetTM extends TableManager {
    ...
    *  TABLE_NAME
    */
   public static final String TABLE_NAME = SystemParam.getSchema("THIP") + "VAR_BUD_CMM_DET";
    ...
    *  CLASS_NAME
    */
   private static final String CLASS_NAME = it.thera.thip.produzione.commessa.VariaBudgetCommessaDet.class.getName();

   public synchronized static TableManager getInstance() throws SQLException {
      if (cInstance == null) {
         cInstance = (TableManager)Factory.createObject(VariaBudgetCommessaDetTM.class);
      }
      return cInstance;
   }

   public VariaBudgetCommessaDetTM() throws SQLException {
      super();
   }
