...
/**
 * EvoluzioneBudgetCommessaDetPQGrid
 ...
 */
public class EvoluzioneBudgetCommessaDetPQGrid extends WebParamQuery{
	
	protected EvoluzioneBudgetCommessa iEvoluzioneBudget = null;
	
	public EvoluzioneBudgetCommessaDetPQGrid(ServletEnvironment se) {
		setServletEnvironment(se);
		setName("grid_EvoluzioneBudgetCommessaDet");
		initEvoluzioneBudgetCommessa(se);
	}
	
	public EvoluzioneBudgetCommessa getEvoluzioneBudgetCommessa() {
		return iEvoluzioneBudget; 
	}
	
	public void setEvoluzioneBudgetCommessa(EvoluzioneBudgetCommessa evoluzioneBudget) {
		iEvoluzioneBudget = evoluzioneBudget;
	}
	
	public void initEvoluzioneBudgetCommessa(ServletEnvironment se){	
		EvoluzioneBudgetCommessa evoluzioneBudget = null;
	    ...
	    evoluzioneBudget = (EvoluzioneBudgetCommessa)Factory.createObject(EvoluzioneBudgetCommessa.class);
		
		evoluzioneBudget.setIdAzienda(idAzienda);
		evoluzioneBudget.setIdCommessa(idCommessa);
		evoluzioneBudget.setDataInizio(dataInizio);
		evoluzioneBudget.setDataFine(dataFine);
		evoluzioneBudget.setTotali(totali);
		evoluzioneBudget.setDettagliCommessa(dettagliCommessa);
		evoluzioneBudget.setDettagliSottoCommesse(dettagliSottoCommesse);
		evoluzioneBudget.setComponentiPropri(componentiPropri);
		evoluzioneBudget.setSoloComponentiValorizzate(soloComponentiValorizzate);
		setEvoluzioneBudgetCommessa(evoluzioneBudget);	    	    
	}
	
	public void write(PrintWriter out) throws IOException, JSONException {	
		initializeGridDescriptorAttributes();		
		super.write(out);		
      out.println(com.thera.thermfw.web.WebJSTypeList.getImportForJSLibrary("it/thera/thip/produzione/commessa/EvoluzioneBudgetCommessa.js",  getServletEnvironment().getRequest()));
	}
	...
	protected JSONObject getData() throws JSONException {
      ...
      data.put("data", iEvoluzioneBudget.getDataModel());
      data.put("TotHH", "");
      data.put("TotVal", "");
      return data;
	}
	...
	protected JSONArray getColumnModel() throws JSONException {
		return getEvoluzioneBudgetCommessa().getColumnsDescriptors();
	}
	...
	public List check() {
		...
		boDC.initialize("EvoluzioneBudgetCommessa");
		boDC.setBo(getEvoluzioneBudgetCommessa());
		boDC.check();
